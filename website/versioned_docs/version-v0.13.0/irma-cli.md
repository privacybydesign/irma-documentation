...
> If you run using Docker, then you should replace `irma session` with `docker run -p 48680:48680 ghcr.io/privacybydesign/irma:latest session --url "http://$IP:48680"` where `$IP` is your local IP address.
